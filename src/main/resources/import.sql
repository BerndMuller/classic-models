;              
DROP TABLE PUBLIC.CUSTOMERS IF EXISTS;
DROP TABLE PUBLIC.EMPLOYEES IF EXISTS;
DROP TABLE PUBLIC.OFFICES IF EXISTS;
DROP TABLE PUBLIC.ORDERS IF EXISTS;
DROP TABLE PUBLIC.PAYMENTS IF EXISTS;
DROP TABLE PUBLIC.ORDERDETAILS IF EXISTS;
DROP TABLE PUBLIC.PRODUCTS IF EXISTS;
DROP TABLE PUBLIC.PRODUCTLINES IF EXISTS;
;
CREATE CACHED TABLE PUBLIC.CUSTOMERS(
    CUSTOMERNUMBER IDENTITY NOT NULL,
...
(144, 'Volvo Model Replicas, Co', 'Berglund', 'Christina ', '0921-12 3555', STRINGDECODE('Berguvsv\u00e4gen  8'), NULL, STRINGDECODE('Lule\u00e5'), NULL, 'S-958 22', 'Sweden', 1504, 53100.0),
(145, 'Danish Wholesale Imports', 'Petersen', 'Jytte ', '31 12 3555', STRINGDECODE('Vinb\u00e6ltet 34'), NULL, 'Kobenhavn', NULL, '1734', 'Denmark', 1401, 83400.0),
...
(169, 'Porto Imports Co.', 'de Castro', 'Isabel ', '(1) 356-5555', STRINGDECODE('Estrada da sa\u00fade n. 58'), NULL, 'Lisboa', NULL, '1756', 'Portugal', NULL, 0.0),
(171, 'Daedalus Designs Imports', STRINGDECODE('Ranc\u00e9'), 'Martine ', '20.16.1555', STRINGDECODE('184, chauss\u00e9e de Tournai'), NULL, 'Lille', NULL, '59000', 'France', 1370, 82900.0),
...
(209, 'Mini Caravy', 'Citeaux', STRINGDECODE('Fr\u00e9d\u00e9rique '), '88.60.1555', STRINGDECODE('24, place Kl\u00e9ber'), NULL, 'Strasbourg', NULL, '67000', 'France', 1370, 53800.0),
...
(216, 'Enaco Distributors', 'Saavedra', 'Eduardo ', '(93) 203 4555', STRINGDECODE('Rambla de Catalu\u00f1a, 23'), NULL, 'Barcelona', NULL, '08022', 'Spain', 1702, 60300.0),
(219, 'Boards & Toys Co.', 'Young', 'Mary', '3105552373', '4097 Douglas Av.', NULL, 'Glendale', 'CA', '92561', 'USA', 1166, 11000.0),
(223, STRINGDECODE('Nat\u00fcrlich Autos'), 'Kloss', 'Horst ', '0372-555188', STRINGDECODE('Taucherstra\u00dfe 10'), NULL, 'Cunewalde', NULL, '01307', 'Germany', NULL, 0.0),
(227, 'Heintze Collectables', 'Ibsen', 'Palle', '86 21 3555', 'Smagsloget 45', NULL, STRINGDECODE('\u00c5rhus'), NULL, '8200', 'Denmark', 1401, 120800.0),
(233, STRINGDECODE('Qu\u00e9bec Home Shopping Network'), STRINGDECODE('Fresni\u00e8re'), 'Jean ', '(514) 555-8054', '43 rue St. Laurent', NULL, STRINGDECODE('Montr\u00e9al'), STRINGDECODE('Qu\u00e9bec'), 'H1J 1C3', 'Canada', 1286, 48700.0),
(237, 'ANG Resellers', 'Camino', 'Alejandra ', '(91) 745 6555', STRINGDECODE('Gran V\u00eda, 1'), NULL, 'Madrid', NULL, '28001', 'Spain', NULL, 0.0),
...
INSERT INTO PUBLIC.CUSTOMERS(CUSTOMERNUMBER, CUSTOMERNAME, CONTACTLASTNAME, CONTACTFIRSTNAME, PHONE, ADDRESSLINE1, ADDRESSLINE2, CITY, STATE, POSTALCODE, COUNTRY, SALESREPEMPLOYEENUMBER, CREDITLIMIT) VALUES
(256, STRINGDECODE('Auto Associ\u00e9s & Cie.'), 'Tonini', 'Daniel ', '30.59.8555', '67, avenue de l''Europe', NULL, 'Versailles', NULL, '78000', 'France', 1370, 77900.0),
(259, STRINGDECODE('Toms Spezialit\u00e4ten, Ltd'), 'Pfalzheim', 'Henriette ', '0221-5554327', 'Mehrheimerstr. 369', NULL, STRINGDECODE('K\u00f6ln'), NULL, '50739', 'Germany', 1504, 120400.0),
...
(273, 'Franken Gifts, Co', 'Franken', 'Peter ', '089-0877555', 'Berliner Platz 43', NULL, STRINGDECODE('M\u00fcnchen'), NULL, '80805', 'Germany', NULL, 0.0),
...
(298, 'Vida Sport, Ltd', 'Holz', 'Mihael', '0897-034555', 'Grenzacherweg 237', NULL, STRINGDECODE('Gen\u00e8ve'), NULL, '1203', 'Switzerland', 1702, 141300.0),
...
(335, STRINGDECODE('Cramer Spezialit\u00e4ten, Ltd'), 'Cramer', 'Philip ', '0555-09555', 'Maubelstr. 90', NULL, 'Brandenburg', NULL, '14776', 'Germany', NULL, 0.0),
...
(361, 'Kommission Auto', 'Josephs', 'Karin', '0251-555259', 'Luisenstr. 48', NULL, STRINGDECODE('M\u00fcnster'), NULL, '44087', 'Germany', NULL, 0.0),
...
(409, 'Stuttgart Collectable Exchange', STRINGDECODE('M\u00fcller'), 'Rita ', '0711-555361', 'Adenauerallee 900', NULL, 'Stuttgart', NULL, '70563', 'Germany', NULL, 0.0),
...
(448, 'Scandinavian Gift Ideas', 'Larsson', 'Martha', '0695-34 6555', STRINGDECODE('\u00c5kergatan 24'), NULL, STRINGDECODE('Br\u00e4cke'), NULL, 'S-844 67', 'Sweden', 1504, 116400.0);        
INSERT INTO PUBLIC.CUSTOMERS(CUSTOMERNUMBER, CUSTOMERNAME, CONTACTLASTNAME, CONTACTFIRSTNAME, PHONE, ADDRESSLINE1, ADDRESSLINE2, CITY, STATE, POSTALCODE, COUNTRY, SALESREPEMPLOYEENUMBER, CREDITLIMIT) VALUES
...
(458, 'Corrida Auto Replicas, Ltd', 'Sommer', STRINGDECODE('Mart\u00edn '), '(91) 555 22 82', 'C/ Araquil, 67', NULL, 'Madrid', NULL, '28023', 'Spain', 1702, 104600.0),
...
(477, STRINGDECODE('Mit Vergn\u00fcgen & Co.'), 'Moos', 'Hanna ', '0621-08555', 'Forsterstr. 57', NULL, 'Mannheim', NULL, '68306', 'Germany', NULL, 0.0),
...
(484, 'Iberia Gift Imports, Corp.', 'Roel', STRINGDECODE('Jos\u00e9 Pedro '), '(95) 555 82 82', 'C/ Romero, 33', NULL, 'Sevilla', NULL, '41101', 'Spain', 1702, 65700.0),
...
CREATE CACHED TABLE PUBLIC.ORDERDETAILS(
    ...
    PRODUCTCODE VARCHAR(15) NOT NULL SELECTIVITY 5,
    QUANTITYORDERED INTEGER NOT NULL SELECTIVITY 1,
    PRICEEACH DECIMAL NOT NULL SELECTIVITY 63,
    ORDERLINENUMBER INTEGER NOT NULL SELECTIVITY 1
);         
...
CREATE CACHED TABLE PUBLIC.ORDERS(
    ORDERNUMBER INTEGER AUTO_INCREMENT PRIMARY KEY,
...
(10100, DATE '2003-01-06', DATE '2003-01-13', DATE '2003-01-10', 'Shipped', NULL, 363),
(10101, DATE '2003-01-09', DATE '2003-01-18', DATE '2003-01-11', 'Shipped', 'Check on availability.', 128),
(10102, DATE '2003-01-10', DATE '2003-01-18', DATE '2003-01-14', 'Shipped', NULL, 181),
(10103, DATE '2003-01-29', DATE '2003-02-07', DATE '2003-02-02', 'Shipped', NULL, 121),
(10104, DATE '2003-01-31', DATE '2003-02-09', DATE '2003-02-01', 'Shipped', NULL, 141),
(10105, DATE '2003-02-11', DATE '2003-02-21', DATE '2003-02-12', 'Shipped', NULL, 145),
(10106, DATE '2003-02-17', DATE '2003-02-24', DATE '2003-02-21', 'Shipped', NULL, 278),
(10107, DATE '2003-02-24', DATE '2003-03-03', DATE '2003-02-26', 'Shipped', 'Difficult to negotiate with customer. We need more marketing materials', 131),
(10108, DATE '2003-03-03', DATE '2003-03-12', DATE '2003-03-08', 'Shipped', NULL, 385),
(10109, DATE '2003-03-10', DATE '2003-03-19', DATE '2003-03-11', 'Shipped', 'Customer requested that FedEx Ground is used for this shipping', 486),
(10110, DATE '2003-03-18', DATE '2003-03-24', DATE '2003-03-20', 'Shipped', NULL, 187),
(10111, DATE '2003-03-25', DATE '2003-03-31', DATE '2003-03-30', 'Shipped', NULL, 129),
(10112, DATE '2003-03-24', DATE '2003-04-03', DATE '2003-03-29', 'Shipped', 'Customer requested that ad materials (such as posters, pamphlets) be included in the shippment', 144),
(10113, DATE '2003-03-26', DATE '2003-04-02', DATE '2003-03-27', 'Shipped', NULL, 124),
(10114, DATE '2003-04-01', DATE '2003-04-07', DATE '2003-04-02', 'Shipped', NULL, 172),
(10115, DATE '2003-04-04', DATE '2003-04-12', DATE '2003-04-07', 'Shipped', NULL, 424),
(10116, DATE '2003-04-11', DATE '2003-04-19', DATE '2003-04-13', 'Shipped', NULL, 381),
(10117, DATE '2003-04-16', DATE '2003-04-24', DATE '2003-04-17', 'Shipped', NULL, 148),
(10118, DATE '2003-04-21', DATE '2003-04-29', DATE '2003-04-26', 'Shipped', 'Customer has worked with some of our vendors in the past and is aware of their MSRP', 216),
(10119, DATE '2003-04-28', DATE '2003-05-05', DATE '2003-05-02', 'Shipped', NULL, 382),
(10120, DATE '2003-04-29', DATE '2003-05-08', DATE '2003-05-01', 'Shipped', NULL, 114),
(10121, DATE '2003-05-07', DATE '2003-05-13', DATE '2003-05-13', 'Shipped', NULL, 353),
(10122, DATE '2003-05-08', DATE '2003-05-16', DATE '2003-05-13', 'Shipped', NULL, 350),
(10123, DATE '2003-05-20', DATE '2003-05-29', DATE '2003-05-22', 'Shipped', NULL, 103),
(10124, DATE '2003-05-21', DATE '2003-05-29', DATE '2003-05-25', 'Shipped', 'Customer very concerned about the exact color of the models. There is high risk that he may dispute the order because there is a slight color mismatch', 112),
(10125, DATE '2003-05-21', DATE '2003-05-27', DATE '2003-05-24', 'Shipped', NULL, 114);     
INSERT INTO PUBLIC.ORDERS(ORDERNUMBER, ORDERDATE, REQUIREDDATE, SHIPPEDDATE, STATUS, COMMENTS, CUSTOMERNUMBER) VALUES
(10126, DATE '2003-05-28', DATE '2003-06-07', DATE '2003-06-02', 'Shipped', NULL, 458),
(10127, DATE '2003-06-03', DATE '2003-06-09', DATE '2003-06-06', 'Shipped', 'Customer requested special shippment. The instructions were passed along to the warehouse', 151),
(10128, DATE '2003-06-06', DATE '2003-06-12', DATE '2003-06-11', 'Shipped', NULL, 141),
(10129, DATE '2003-06-12', DATE '2003-06-18', DATE '2003-06-14', 'Shipped', NULL, 324),
(10130, DATE '2003-06-16', DATE '2003-06-24', DATE '2003-06-21', 'Shipped', NULL, 198),
(10131, DATE '2003-06-16', DATE '2003-06-25', DATE '2003-06-21', 'Shipped', NULL, 447),
(10132, DATE '2003-06-25', DATE '2003-07-01', DATE '2003-06-28', 'Shipped', NULL, 323),
(10133, DATE '2003-06-27', DATE '2003-07-04', DATE '2003-07-03', 'Shipped', NULL, 141),
(10134, DATE '2003-07-01', DATE '2003-07-10', DATE '2003-07-05', 'Shipped', NULL, 250),
(10135, DATE '2003-07-02', DATE '2003-07-12', DATE '2003-07-03', 'Shipped', NULL, 124),
(10136, DATE '2003-07-04', DATE '2003-07-14', DATE '2003-07-06', 'Shipped', 'Customer is interested in buying more Ferrari models', 242),
(10137, DATE '2003-07-10', DATE '2003-07-20', DATE '2003-07-14', 'Shipped', NULL, 353),
(10138, DATE '2003-07-07', DATE '2003-07-16', DATE '2003-07-13', 'Shipped', NULL, 496),
(10139, DATE '2003-07-16', DATE '2003-07-23', DATE '2003-07-21', 'Shipped', NULL, 282),
(10140, DATE '2003-07-24', DATE '2003-08-02', DATE '2003-07-30', 'Shipped', NULL, 161),
(10141, DATE '2003-08-01', DATE '2003-08-09', DATE '2003-08-04', 'Shipped', NULL, 334),
(10142, DATE '2003-08-08', DATE '2003-08-16', DATE '2003-08-13', 'Shipped', NULL, 124),
(10143, DATE '2003-08-10', DATE '2003-08-18', DATE '2003-08-12', 'Shipped', 'Can we deliver the new Ford Mustang models by end-of-quarter?', 320),
(10144, DATE '2003-08-13', DATE '2003-08-21', DATE '2003-08-14', 'Shipped', NULL, 381),
(10145, DATE '2003-08-25', DATE '2003-09-02', DATE '2003-08-31', 'Shipped', NULL, 205),
(10146, DATE '2003-09-03', DATE '2003-09-13', DATE '2003-09-06', 'Shipped', NULL, 447),
(10147, DATE '2003-09-05', DATE '2003-09-12', DATE '2003-09-09', 'Shipped', NULL, 379),
(10148, DATE '2003-09-11', DATE '2003-09-21', DATE '2003-09-15', 'Shipped', 'They want to reevaluate their terms agreement with Finance.', 276),
(10149, DATE '2003-09-12', DATE '2003-09-18', DATE '2003-09-17', 'Shipped', NULL, 487),
(10150, DATE '2003-09-19', DATE '2003-09-27', DATE '2003-09-21', 'Shipped', 'They want to reevaluate their terms agreement with Finance.', 148),
(10151, DATE '2003-09-21', DATE '2003-09-30', DATE '2003-09-24', 'Shipped', NULL, 311),
(10152, DATE '2003-09-25', DATE '2003-10-03', DATE '2003-10-01', 'Shipped', NULL, 333);            
INSERT INTO PUBLIC.ORDERS(ORDERNUMBER, ORDERDATE, REQUIREDDATE, SHIPPEDDATE, STATUS, COMMENTS, CUSTOMERNUMBER) VALUES
(10153, DATE '2003-09-28', DATE '2003-10-05', DATE '2003-10-03', 'Shipped', NULL, 141),
(10154, DATE '2003-10-02', DATE '2003-10-12', DATE '2003-10-08', 'Shipped', NULL, 219),
(10155, DATE '2003-10-06', DATE '2003-10-13', DATE '2003-10-07', 'Shipped', NULL, 186),
(10156, DATE '2003-10-08', DATE '2003-10-17', DATE '2003-10-11', 'Shipped', NULL, 141),
(10157, DATE '2003-10-09', DATE '2003-10-15', DATE '2003-10-14', 'Shipped', NULL, 473),
(10158, DATE '2003-10-10', DATE '2003-10-18', DATE '2003-10-15', 'Shipped', NULL, 121),
(10159, DATE '2003-10-10', DATE '2003-10-19', DATE '2003-10-16', 'Shipped', NULL, 321),
(10160, DATE '2003-10-11', DATE '2003-10-17', DATE '2003-10-17', 'Shipped', NULL, 347),
(10161, DATE '2003-10-17', DATE '2003-10-25', DATE '2003-10-20', 'Shipped', NULL, 227),
(10162, DATE '2003-10-18', DATE '2003-10-26', DATE '2003-10-19', 'Shipped', NULL, 321),
(10163, DATE '2003-10-20', DATE '2003-10-27', DATE '2003-10-24', 'Shipped', NULL, 424),
(10164, DATE '2003-10-21', DATE '2003-10-30', DATE '2003-10-23', 'Resolved', 'This order was disputed, but resolved on 11.1.2003. Customer doesn''t like the colors and precision of the models.', 452),
(10165, DATE '2003-10-22', DATE '2003-10-31', DATE '2003-12-26', 'Shipped', 'This order was on hold because customers''s credit limit had been exceeded. Order will ship when payment is received', 148),
(10166, DATE '2003-10-21', DATE '2003-10-30', DATE '2003-10-27', 'Shipped', NULL, 462),
(10167, DATE '2003-10-23', DATE '2003-10-30', NULL, 'Cancelled', 'Customer called to cancel. The warehouse was notified in time and the order didn''t ship. They have a new VP of Sales and are shifting their sales model. Our VP of Sales should contact them.', 448),
(10168, DATE '2003-10-28', DATE '2003-11-03', DATE '2003-11-01', 'Shipped', NULL, 161),
(10169, DATE '2003-11-04', DATE '2003-11-14', DATE '2003-11-09', 'Shipped', NULL, 276),
(10170, DATE '2003-11-04', DATE '2003-11-12', DATE '2003-11-07', 'Shipped', NULL, 452),
(10171, DATE '2003-11-05', DATE '2003-11-13', DATE '2003-11-07', 'Shipped', NULL, 233),
(10172, DATE '2003-11-05', DATE '2003-11-14', DATE '2003-11-11', 'Shipped', NULL, 175),
(10173, DATE '2003-11-05', DATE '2003-11-15', DATE '2003-11-09', 'Shipped', 'Cautious optimism. We have happy customers here, if we can keep them well stocked.  I need all the information I can get on the planned shippments of Porches', 278),
(10174, DATE '2003-11-06', DATE '2003-11-15', DATE '2003-11-10', 'Shipped', NULL, 333),
(10175, DATE '2003-11-06', DATE '2003-11-14', DATE '2003-11-09', 'Shipped', NULL, 324),
(10176, DATE '2003-11-06', DATE '2003-11-15', DATE '2003-11-12', 'Shipped', NULL, 386),
(10177, DATE '2003-11-07', DATE '2003-11-17', DATE '2003-11-12', 'Shipped', NULL, 344),
(10178, DATE '2003-11-08', DATE '2003-11-16', DATE '2003-11-10', 'Shipped', 'Custom shipping instructions sent to warehouse', 242);               
INSERT INTO PUBLIC.ORDERS(ORDERNUMBER, ORDERDATE, REQUIREDDATE, SHIPPEDDATE, STATUS, COMMENTS, CUSTOMERNUMBER) VALUES
(10179, DATE '2003-11-11', DATE '2003-11-17', DATE '2003-11-13', 'Cancelled', 'Customer cancelled due to urgent budgeting issues. Must be cautious when dealing with them in the future. Since order shipped already we must discuss who would cover the shipping charges.', 496),
(10180, DATE '2003-11-11', DATE '2003-11-19', DATE '2003-11-14', 'Shipped', NULL, 171),
(10181, DATE '2003-11-12', DATE '2003-11-19', DATE '2003-11-15', 'Shipped', NULL, 167),
(10182, DATE '2003-11-12', DATE '2003-11-21', DATE '2003-11-18', 'Shipped', NULL, 124),
(10183, DATE '2003-11-13', DATE '2003-11-22', DATE '2003-11-15', 'Shipped', 'We need to keep in close contact with their Marketing VP. He is the decision maker for all their purchases.', 339),
(10184, DATE '2003-11-14', DATE '2003-11-22', DATE '2003-11-20', 'Shipped', NULL, 484),
(10185, DATE '2003-11-14', DATE '2003-11-21', DATE '2003-11-20', 'Shipped', NULL, 320),
(10186, DATE '2003-11-14', DATE '2003-11-20', DATE '2003-11-18', 'Shipped', 'They want to reevaluate their terms agreement with the VP of Sales', 489),
(10187, DATE '2003-11-15', DATE '2003-11-24', DATE '2003-11-16', 'Shipped', NULL, 211),
(10188, DATE '2003-11-18', DATE '2003-11-26', DATE '2003-11-24', 'Shipped', NULL, 167),
(10189, DATE '2003-11-18', DATE '2003-11-25', DATE '2003-11-24', 'Shipped', 'They want to reevaluate their terms agreement with Finance.', 205),
(10190, DATE '2003-11-19', DATE '2003-11-29', DATE '2003-11-20', 'Shipped', NULL, 141),
(10191, DATE '2003-11-20', DATE '2003-11-30', DATE '2003-11-24', 'Shipped', 'We must be cautions with this customer. Their VP of Sales resigned. Company may be heading down.', 259),
(10192, DATE '2003-11-20', DATE '2003-11-29', DATE '2003-11-25', 'Shipped', NULL, 363),
(10193, DATE '2003-11-21', DATE '2003-11-28', DATE '2003-11-27', 'Shipped', NULL, 471),
(10194, DATE '2003-11-25', DATE '2003-12-02', DATE '2003-11-26', 'Shipped', NULL, 146),
(10195, DATE '2003-11-25', DATE '2003-12-01', DATE '2003-11-28', 'Shipped', NULL, 319),
(10196, DATE '2003-11-26', DATE '2003-12-03', DATE '2003-12-01', 'Shipped', NULL, 455),
(10197, DATE '2003-11-26', DATE '2003-12-02', DATE '2003-12-01', 'Shipped', 'Customer inquired about remote controlled models and gold models.', 216),
(10198, DATE '2003-11-27', DATE '2003-12-06', DATE '2003-12-03', 'Shipped', NULL, 385),
(10199, DATE '2003-12-01', DATE '2003-12-10', DATE '2003-12-06', 'Shipped', NULL, 475),
(10200, DATE '2003-12-01', DATE '2003-12-09', DATE '2003-12-06', 'Shipped', NULL, 211),
(10201, DATE '2003-12-01', DATE '2003-12-11', DATE '2003-12-02', 'Shipped', NULL, 129),
(10202, DATE '2003-12-02', DATE '2003-12-09', DATE '2003-12-06', 'Shipped', NULL, 357),
(10203, DATE '2003-12-02', DATE '2003-12-11', DATE '2003-12-07', 'Shipped', NULL, 141),
(10204, DATE '2003-12-02', DATE '2003-12-10', DATE '2003-12-04', 'Shipped', NULL, 151);
INSERT INTO PUBLIC.ORDERS(ORDERNUMBER, ORDERDATE, REQUIREDDATE, SHIPPEDDATE, STATUS, COMMENTS, CUSTOMERNUMBER) VALUES
(10205, DATE '2003-12-03', DATE '2003-12-09', DATE '2003-12-07', 'Shipped', ' I need all the information I can get on our competitors.', 141),
(10206, DATE '2003-12-05', DATE '2003-12-13', DATE '2003-12-08', 'Shipped', 'Can we renegotiate this one?', 202),
(10207, DATE '2003-12-09', DATE '2003-12-17', DATE '2003-12-11', 'Shipped', 'Check on availability.', 495),
(10208, DATE '2004-01-02', DATE '2004-01-11', DATE '2004-01-04', 'Shipped', NULL, 146),
(10209, DATE '2004-01-09', DATE '2004-01-15', DATE '2004-01-12', 'Shipped', NULL, 347),
(10210, DATE '2004-01-12', DATE '2004-01-22', DATE '2004-01-20', 'Shipped', NULL, 177),
(10211, DATE '2004-01-15', DATE '2004-01-25', DATE '2004-01-18', 'Shipped', NULL, 406),
(10212, DATE '2004-01-16', DATE '2004-01-24', DATE '2004-01-18', 'Shipped', NULL, 141),
(10213, DATE '2004-01-22', DATE '2004-01-28', DATE '2004-01-27', 'Shipped', 'Difficult to negotiate with customer. We need more marketing materials', 489),
(10214, DATE '2004-01-26', DATE '2004-02-04', DATE '2004-01-29', 'Shipped', NULL, 458),
(10215, DATE '2004-01-29', DATE '2004-02-08', DATE '2004-02-01', 'Shipped', 'Customer requested that FedEx Ground is used for this shipping', 475),
(10216, DATE '2004-02-02', DATE '2004-02-10', DATE '2004-02-04', 'Shipped', NULL, 256),
(10217, DATE '2004-02-04', DATE '2004-02-14', DATE '2004-02-06', 'Shipped', NULL, 166),
(10218, DATE '2004-02-09', DATE '2004-02-16', DATE '2004-02-11', 'Shipped', 'Customer requested that ad materials (such as posters, pamphlets) be included in the shippment', 473),
(10219, DATE '2004-02-10', DATE '2004-02-17', DATE '2004-02-12', 'Shipped', NULL, 487),
(10220, DATE '2004-02-12', DATE '2004-02-19', DATE '2004-02-16', 'Shipped', NULL, 189),
(10221, DATE '2004-02-18', DATE '2004-02-26', DATE '2004-02-19', 'Shipped', NULL, 314),
(10222, DATE '2004-02-19', DATE '2004-02-27', DATE '2004-02-20', 'Shipped', NULL, 239),
(10223, DATE '2004-02-20', DATE '2004-02-29', DATE '2004-02-24', 'Shipped', NULL, 114),
(10224, DATE '2004-02-21', DATE '2004-03-02', DATE '2004-02-26', 'Shipped', 'Customer has worked with some of our vendors in the past and is aware of their MSRP', 171),
(10225, DATE '2004-02-22', DATE '2004-03-01', DATE '2004-02-24', 'Shipped', NULL, 298),
(10226, DATE '2004-02-26', DATE '2004-03-06', DATE '2004-03-02', 'Shipped', NULL, 239),
(10227, DATE '2004-03-02', DATE '2004-03-12', DATE '2004-03-08', 'Shipped', NULL, 146),
(10228, DATE '2004-03-10', DATE '2004-03-18', DATE '2004-03-13', 'Shipped', NULL, 173),
(10229, DATE '2004-03-11', DATE '2004-03-20', DATE '2004-03-12', 'Shipped', NULL, 124),
(10230, DATE '2004-03-15', DATE '2004-03-24', DATE '2004-03-20', 'Shipped', 'Customer very concerned about the exact color of the models. There is high risk that he may dispute the order because there is a slight color mismatch', 128);    
INSERT INTO PUBLIC.ORDERS(ORDERNUMBER, ORDERDATE, REQUIREDDATE, SHIPPEDDATE, STATUS, COMMENTS, CUSTOMERNUMBER) VALUES
(10231, DATE '2004-03-19', DATE '2004-03-26', DATE '2004-03-25', 'Shipped', NULL, 344),
(10232, DATE '2004-03-20', DATE '2004-03-30', DATE '2004-03-25', 'Shipped', NULL, 240),
(10233, DATE '2004-03-29', DATE '2004-04-04', DATE '2004-04-02', 'Shipped', 'Customer requested special shippment. The instructions were passed along to the warehouse', 328),
(10234, DATE '2004-03-30', DATE '2004-04-05', DATE '2004-04-02', 'Shipped', NULL, 412),
(10235, DATE '2004-04-02', DATE '2004-04-12', DATE '2004-04-06', 'Shipped', NULL, 260),
(10236, DATE '2004-04-03', DATE '2004-04-11', DATE '2004-04-08', 'Shipped', NULL, 486),
(10237, DATE '2004-04-05', DATE '2004-04-12', DATE '2004-04-10', 'Shipped', NULL, 181),
(10238, DATE '2004-04-09', DATE '2004-04-16', DATE '2004-04-10', 'Shipped', NULL, 145),
(10239, DATE '2004-04-12', DATE '2004-04-21', DATE '2004-04-17', 'Shipped', NULL, 311),
(10240, DATE '2004-04-13', DATE '2004-04-20', DATE '2004-04-20', 'Shipped', NULL, 177),
(10241, DATE '2004-04-13', DATE '2004-04-20', DATE '2004-04-19', 'Shipped', NULL, 209),
(10242, DATE '2004-04-20', DATE '2004-04-28', DATE '2004-04-25', 'Shipped', 'Customer is interested in buying more Ferrari models', 456),
(10243, DATE '2004-04-26', DATE '2004-05-03', DATE '2004-04-28', 'Shipped', NULL, 495),
(10244, DATE '2004-04-29', DATE '2004-05-09', DATE '2004-05-04', 'Shipped', NULL, 141),
(10245, DATE '2004-05-04', DATE '2004-05-12', DATE '2004-05-09', 'Shipped', NULL, 455),
(10246, DATE '2004-05-05', DATE '2004-05-13', DATE '2004-05-06', 'Shipped', NULL, 141),
(10247, DATE '2004-05-05', DATE '2004-05-11', DATE '2004-05-08', 'Shipped', NULL, 334),
(10248, DATE '2004-05-07', DATE '2004-05-14', NULL, 'Cancelled', 'Order was mistakenly placed. The warehouse noticed the lack of documentation.', 131),
(10249, DATE '2004-05-08', DATE '2004-05-17', DATE '2004-05-11', 'Shipped', 'Can we deliver the new Ford Mustang models by end-of-quarter?', 173),
(10250, DATE '2004-05-11', DATE '2004-05-19', DATE '2004-05-15', 'Shipped', NULL, 450),
(10251, DATE '2004-05-18', DATE '2004-05-24', DATE '2004-05-24', 'Shipped', NULL, 328),
(10252, DATE '2004-05-26', DATE '2004-06-04', DATE '2004-05-29', 'Shipped', NULL, 406),
(10253, DATE '2004-06-01', DATE '2004-06-09', DATE '2004-06-02', 'Cancelled', 'Customer disputed the order and we agreed to cancel it. We must be more cautions with this customer going forward, since they are very hard to please. We must cover the shipping fees.', 201),
(10254, DATE '2004-06-03', DATE '2004-06-13', DATE '2004-06-04', 'Shipped', 'Customer requested that DHL is used for this shipping', 323),
(10255, DATE '2004-06-04', DATE '2004-06-12', DATE '2004-06-09', 'Shipped', NULL, 209),
(10256, DATE '2004-06-08', DATE '2004-06-16', DATE '2004-06-10', 'Shipped', NULL, 145);            
INSERT INTO PUBLIC.ORDERS(ORDERNUMBER, ORDERDATE, REQUIREDDATE, SHIPPEDDATE, STATUS, COMMENTS, CUSTOMERNUMBER) VALUES
(10257, DATE '2004-06-14', DATE '2004-06-24', DATE '2004-06-15', 'Shipped', NULL, 450),
(10258, DATE '2004-06-15', DATE '2004-06-25', DATE '2004-06-23', 'Shipped', NULL, 398),
(10259, DATE '2004-06-15', DATE '2004-06-22', DATE '2004-06-17', 'Shipped', NULL, 166),
(10260, DATE '2004-06-16', DATE '2004-06-22', NULL, 'Cancelled', 'Customer heard complaints from their customers and called to cancel this order. Will notify the Sales Manager.', 357),
(10261, DATE '2004-06-17', DATE '2004-06-25', DATE '2004-06-22', 'Shipped', NULL, 233),
(10262, DATE '2004-06-24', DATE '2004-07-01', NULL, 'Cancelled', 'This customer found a better offer from one of our competitors. Will call back to renegotiate.', 141),
(10263, DATE '2004-06-28', DATE '2004-07-04', DATE '2004-07-02', 'Shipped', NULL, 175),
(10264, DATE '2004-06-30', DATE '2004-07-06', DATE '2004-07-01', 'Shipped', 'Customer will send a truck to our local warehouse on 7/1/2004', 362),
(10265, DATE '2004-07-02', DATE '2004-07-09', DATE '2004-07-07', 'Shipped', NULL, 471),
(10266, DATE '2004-07-06', DATE '2004-07-14', DATE '2004-07-10', 'Shipped', NULL, 386),
(10267, DATE '2004-07-07', DATE '2004-07-17', DATE '2004-07-09', 'Shipped', NULL, 151),
(10268, DATE '2004-07-12', DATE '2004-07-18', DATE '2004-07-14', 'Shipped', NULL, 412),
(10269, DATE '2004-07-16', DATE '2004-07-22', DATE '2004-07-18', 'Shipped', NULL, 382),
(10270, DATE '2004-07-19', DATE '2004-07-27', DATE '2004-07-24', 'Shipped', 'Can we renegotiate this one?', 282),
(10271, DATE '2004-07-20', DATE '2004-07-29', DATE '2004-07-23', 'Shipped', NULL, 124),
(10272, DATE '2004-07-20', DATE '2004-07-26', DATE '2004-07-22', 'Shipped', NULL, 157),
(10273, DATE '2004-07-21', DATE '2004-07-28', DATE '2004-07-22', 'Shipped', NULL, 314),
(10274, DATE '2004-07-21', DATE '2004-07-29', DATE '2004-07-22', 'Shipped', NULL, 379),
(10275, DATE '2004-07-23', DATE '2004-08-02', DATE '2004-07-29', 'Shipped', NULL, 119),
(10276, DATE '2004-08-02', DATE '2004-08-11', DATE '2004-08-08', 'Shipped', NULL, 204),
(10277, DATE '2004-08-04', DATE '2004-08-12', DATE '2004-08-05', 'Shipped', NULL, 148),
(10278, DATE '2004-08-06', DATE '2004-08-16', DATE '2004-08-09', 'Shipped', NULL, 112),
(10279, DATE '2004-08-09', DATE '2004-08-19', DATE '2004-08-15', 'Shipped', 'Cautious optimism. We have happy customers here, if we can keep them well stocked.  I need all the information I can get on the planned shippments of Porches', 141),
(10280, DATE '2004-08-17', DATE '2004-08-27', DATE '2004-08-19', 'Shipped', NULL, 249),
(10281, DATE '2004-08-19', DATE '2004-08-28', DATE '2004-08-23', 'Shipped', NULL, 157),
(10282, DATE '2004-08-20', DATE '2004-08-26', DATE '2004-08-22', 'Shipped', NULL, 124),
(10283, DATE '2004-08-20', DATE '2004-08-30', DATE '2004-08-23', 'Shipped', NULL, 260);
INSERT INTO PUBLIC.ORDERS(ORDERNUMBER, ORDERDATE, REQUIREDDATE, SHIPPEDDATE, STATUS, COMMENTS, CUSTOMERNUMBER) VALUES
(10284, DATE '2004-08-21', DATE '2004-08-29', DATE '2004-08-26', 'Shipped', 'Custom shipping instructions sent to warehouse', 299),
(10285, DATE '2004-08-27', DATE '2004-09-04', DATE '2004-08-31', 'Shipped', NULL, 286),
(10286, DATE '2004-08-28', DATE '2004-09-06', DATE '2004-09-01', 'Shipped', NULL, 172),
(10287, DATE '2004-08-30', DATE '2004-09-06', DATE '2004-09-01', 'Shipped', NULL, 298),
(10288, DATE '2004-09-01', DATE '2004-09-11', DATE '2004-09-05', 'Shipped', NULL, 166),
(10289, DATE '2004-09-03', DATE '2004-09-13', DATE '2004-09-04', 'Shipped', 'We need to keep in close contact with their Marketing VP. He is the decision maker for all their purchases.', 167),
(10290, DATE '2004-09-07', DATE '2004-09-15', DATE '2004-09-13', 'Shipped', NULL, 198),
(10291, DATE '2004-09-08', DATE '2004-09-17', DATE '2004-09-14', 'Shipped', NULL, 448),
(10292, DATE '2004-09-08', DATE '2004-09-18', DATE '2004-09-11', 'Shipped', 'They want to reevaluate their terms agreement with Finance.', 131),
(10293, DATE '2004-09-09', DATE '2004-09-18', DATE '2004-09-14', 'Shipped', NULL, 249),
(10294, DATE '2004-09-10', DATE '2004-09-17', DATE '2004-09-14', 'Shipped', NULL, 204),
(10295, DATE '2004-09-10', DATE '2004-09-17', DATE '2004-09-14', 'Shipped', 'They want to reevaluate their terms agreement with Finance.', 362),
(10296, DATE '2004-09-15', DATE '2004-09-22', DATE '2004-09-16', 'Shipped', NULL, 415),
(10297, DATE '2004-09-16', DATE '2004-09-22', DATE '2004-09-21', 'Shipped', 'We must be cautions with this customer. Their VP of Sales resigned. Company may be heading down.', 189),
(10298, DATE '2004-09-27', DATE '2004-10-05', DATE '2004-10-01', 'Shipped', NULL, 103),
(10299, DATE '2004-09-30', DATE '2004-10-10', DATE '2004-10-01', 'Shipped', NULL, 186),
(10300, DATE '2003-10-04', DATE '2003-10-13', DATE '2003-10-09', 'Shipped', NULL, 128),
(10301, DATE '2003-10-05', DATE '2003-10-15', DATE '2003-10-08', 'Shipped', NULL, 299),
(10302, DATE '2003-10-06', DATE '2003-10-16', DATE '2003-10-07', 'Shipped', NULL, 201),
(10303, DATE '2004-10-06', DATE '2004-10-14', DATE '2004-10-09', 'Shipped', 'Customer inquired about remote controlled models and gold models.', 484),
(10304, DATE '2004-10-11', DATE '2004-10-20', DATE '2004-10-17', 'Shipped', NULL, 256),
(10305, DATE '2004-10-13', DATE '2004-10-22', DATE '2004-10-15', 'Shipped', 'Check on availability.', 286),
(10306, DATE '2004-10-14', DATE '2004-10-21', DATE '2004-10-17', 'Shipped', NULL, 187),
(10307, DATE '2004-10-14', DATE '2004-10-23', DATE '2004-10-20', 'Shipped', NULL, 339),
(10308, DATE '2004-10-15', DATE '2004-10-24', DATE '2004-10-20', 'Shipped', 'Customer requested that FedEx Ground is used for this shipping', 319),
(10309, DATE '2004-10-15', DATE '2004-10-24', DATE '2004-10-18', 'Shipped', NULL, 121);      
INSERT INTO PUBLIC.ORDERS(ORDERNUMBER, ORDERDATE, REQUIREDDATE, SHIPPEDDATE, STATUS, COMMENTS, CUSTOMERNUMBER) VALUES
(10310, DATE '2004-10-16', DATE '2004-10-24', DATE '2004-10-18', 'Shipped', NULL, 259),
(10311, DATE '2004-10-16', DATE '2004-10-23', DATE '2004-10-20', 'Shipped', 'Difficult to negotiate with customer. We need more marketing materials', 141),
(10312, DATE '2004-10-21', DATE '2004-10-27', DATE '2004-10-23', 'Shipped', NULL, 124),
(10313, DATE '2004-10-22', DATE '2004-10-28', DATE '2004-10-25', 'Shipped', 'Customer requested that FedEx Ground is used for this shipping', 202),
(10314, DATE '2004-10-22', DATE '2004-11-01', DATE '2004-10-23', 'Shipped', NULL, 227),
(10315, DATE '2004-10-29', DATE '2004-11-08', DATE '2004-10-30', 'Shipped', NULL, 119),
(10316, DATE '2004-11-01', DATE '2004-11-09', DATE '2004-11-07', 'Shipped', 'Customer requested that ad materials (such as posters, pamphlets) be included in the shippment', 240),
(10317, DATE '2004-11-02', DATE '2004-11-12', DATE '2004-11-08', 'Shipped', NULL, 161),
(10318, DATE '2004-11-02', DATE '2004-11-09', DATE '2004-11-07', 'Shipped', NULL, 157),
(10319, DATE '2004-11-03', DATE '2004-11-11', DATE '2004-11-06', 'Shipped', 'Customer requested that DHL is used for this shipping', 456),
(10320, DATE '2004-11-03', DATE '2004-11-13', DATE '2004-11-07', 'Shipped', NULL, 144),
(10321, DATE '2004-11-04', DATE '2004-11-12', DATE '2004-11-07', 'Shipped', NULL, 462),
(10322, DATE '2004-11-04', DATE '2004-11-12', DATE '2004-11-10', 'Shipped', 'Customer has worked with some of our vendors in the past and is aware of their MSRP', 363),
(10323, DATE '2004-11-05', DATE '2004-11-12', DATE '2004-11-09', 'Shipped', NULL, 128),
(10324, DATE '2004-11-05', DATE '2004-11-11', DATE '2004-11-08', 'Shipped', NULL, 181),
(10325, DATE '2004-11-05', DATE '2004-11-13', DATE '2004-11-08', 'Shipped', NULL, 121),
(10326, DATE '2004-11-09', DATE '2004-11-16', DATE '2004-11-10', 'Shipped', NULL, 144),
(10327, DATE '2004-11-10', DATE '2004-11-19', DATE '2004-11-13', 'Resolved', 'Order was disputed and resolved on 12/1/04. The Sales Manager was involved. Customer claims the scales of the models don''t match what was discussed.', 145),
(10328, DATE '2004-11-12', DATE '2004-11-21', DATE '2004-11-18', 'Shipped', 'Customer very concerned about the exact color of the models. There is high risk that he may dispute the order because there is a slight color mismatch', 278),
(10329, DATE '2004-11-15', DATE '2004-11-24', DATE '2004-11-16', 'Shipped', NULL, 131),
(10330, DATE '2004-11-16', DATE '2004-11-25', DATE '2004-11-21', 'Shipped', NULL, 385),
(10331, DATE '2004-11-17', DATE '2004-11-23', DATE '2004-11-23', 'Shipped', 'Customer requested special shippment. The instructions were passed along to the warehouse', 486),
(10332, DATE '2004-11-17', DATE '2004-11-25', DATE '2004-11-18', 'Shipped', NULL, 187),
(10333, DATE '2004-11-18', DATE '2004-11-27', DATE '2004-11-20', 'Shipped', NULL, 129);           
INSERT INTO PUBLIC.ORDERS(ORDERNUMBER, ORDERDATE, REQUIREDDATE, SHIPPEDDATE, STATUS, COMMENTS, CUSTOMERNUMBER) VALUES
(10334, DATE '2004-11-19', DATE '2004-11-28', NULL, 'On Hold', 'The outstaniding balance for this customer exceeds their credit limit. Order will be shipped when a payment is received.', 144),
(10335, DATE '2004-11-19', DATE '2004-11-29', DATE '2004-11-23', 'Shipped', NULL, 124),
(10336, DATE '2004-11-20', DATE '2004-11-26', DATE '2004-11-24', 'Shipped', 'Customer requested that DHL is used for this shipping', 172),
(10337, DATE '2004-11-21', DATE '2004-11-30', DATE '2004-11-26', 'Shipped', NULL, 424),
(10338, DATE '2004-11-22', DATE '2004-12-02', DATE '2004-11-27', 'Shipped', NULL, 381),
(10339, DATE '2004-11-23', DATE '2004-11-30', DATE '2004-11-30', 'Shipped', NULL, 398),
(10340, DATE '2004-11-24', DATE '2004-12-01', DATE '2004-11-25', 'Shipped', 'Customer is interested in buying more Ferrari models', 216),
(10341, DATE '2004-11-24', DATE '2004-12-01', DATE '2004-11-29', 'Shipped', NULL, 382),
(10342, DATE '2004-11-24', DATE '2004-12-01', DATE '2004-11-29', 'Shipped', NULL, 114),
(10343, DATE '2004-11-24', DATE '2004-12-01', DATE '2004-11-26', 'Shipped', NULL, 353),
(10344, DATE '2004-11-25', DATE '2004-12-02', DATE '2004-11-29', 'Shipped', NULL, 350),
(10345, DATE '2004-11-25', DATE '2004-12-01', DATE '2004-11-26', 'Shipped', NULL, 103),
(10346, DATE '2004-11-29', DATE '2004-12-05', DATE '2004-11-30', 'Shipped', NULL, 112),
(10347, DATE '2004-11-29', DATE '2004-12-07', DATE '2004-11-30', 'Shipped', 'Can we deliver the new Ford Mustang models by end-of-quarter?', 114),
(10348, DATE '2004-11-01', DATE '2004-11-08', DATE '2004-11-05', 'Shipped', NULL, 458),
(10349, DATE '2004-12-01', DATE '2004-12-07', DATE '2004-12-03', 'Shipped', NULL, 151),
(10350, DATE '2004-12-02', DATE '2004-12-08', DATE '2004-12-05', 'Shipped', NULL, 141),
(10351, DATE '2004-12-03', DATE '2004-12-11', DATE '2004-12-07', 'Shipped', NULL, 324),
(10352, DATE '2004-12-03', DATE '2004-12-12', DATE '2004-12-09', 'Shipped', NULL, 198),
(10353, DATE '2004-12-04', DATE '2004-12-11', DATE '2004-12-05', 'Shipped', NULL, 447),
(10354, DATE '2004-12-04', DATE '2004-12-10', DATE '2004-12-05', 'Shipped', NULL, 323),
(10355, DATE '2004-12-07', DATE '2004-12-14', DATE '2004-12-13', 'Shipped', NULL, 141),
(10356, DATE '2004-12-09', DATE '2004-12-15', DATE '2004-12-12', 'Shipped', NULL, 250),
(10357, DATE '2004-12-10', DATE '2004-12-16', DATE '2004-12-14', 'Shipped', NULL, 124),
(10358, DATE '2004-12-10', DATE '2004-12-16', DATE '2004-12-16', 'Shipped', 'Customer requested that DHL is used for this shipping', 141),
(10359, DATE '2004-12-15', DATE '2004-12-23', DATE '2004-12-18', 'Shipped', NULL, 353),
(10360, DATE '2004-12-16', DATE '2004-12-22', DATE '2004-12-18', 'Shipped', NULL, 496),
(10361, DATE '2004-12-17', DATE '2004-12-24', DATE '2004-12-20', 'Shipped', NULL, 282);              
INSERT INTO PUBLIC.ORDERS(ORDERNUMBER, ORDERDATE, REQUIREDDATE, SHIPPEDDATE, STATUS, COMMENTS, CUSTOMERNUMBER) VALUES
(10362, DATE '2005-01-05', DATE '2005-01-16', DATE '2005-01-10', 'Shipped', NULL, 161),
(10363, DATE '2005-01-06', DATE '2005-01-12', DATE '2005-01-10', 'Shipped', NULL, 334),
(10364, DATE '2005-01-06', DATE '2005-01-17', DATE '2005-01-09', 'Shipped', NULL, 350),
(10365, DATE '2005-01-07', DATE '2005-01-18', DATE '2005-01-11', 'Shipped', NULL, 320),
(10366, DATE '2005-01-10', DATE '2005-01-19', DATE '2005-01-12', 'Shipped', NULL, 381),
(10367, DATE '2005-01-12', DATE '2005-01-21', DATE '2005-01-16', 'Resolved', 'This order was disputed and resolved on 2/1/2005. Customer claimed that container with shipment was damaged. FedEx''s investigation proved this wrong.', 205),
(10368, DATE '2005-01-19', DATE '2005-01-27', DATE '2005-01-24', 'Shipped', 'Can we renegotiate this one?', 124),
(10369, DATE '2005-01-20', DATE '2005-01-28', DATE '2005-01-24', 'Shipped', NULL, 379),
(10370, DATE '2005-01-20', DATE '2005-02-01', DATE '2005-01-25', 'Shipped', NULL, 276),
(10371, DATE '2005-01-23', DATE '2005-02-03', DATE '2005-01-25', 'Shipped', NULL, 124),
(10372, DATE '2005-01-26', DATE '2005-02-05', DATE '2005-01-28', 'Shipped', NULL, 398),
(10373, DATE '2005-01-31', DATE '2005-02-08', DATE '2005-02-06', 'Shipped', NULL, 311),
(10374, DATE '2005-02-02', DATE '2005-02-09', DATE '2005-02-03', 'Shipped', NULL, 333),
(10375, DATE '2005-02-03', DATE '2005-02-10', DATE '2005-02-06', 'Shipped', NULL, 119),
(10376, DATE '2005-02-08', DATE '2005-02-18', DATE '2005-02-13', 'Shipped', NULL, 219),
(10377, DATE '2005-02-09', DATE '2005-02-21', DATE '2005-02-12', 'Shipped', 'Cautious optimism. We have happy customers here, if we can keep them well stocked.  I need all the information I can get on the planned shippments of Porches', 186),
(10378, DATE '2005-02-10', DATE '2005-02-18', DATE '2005-02-11', 'Shipped', NULL, 141),
(10379, DATE '2005-02-10', DATE '2005-02-18', DATE '2005-02-11', 'Shipped', NULL, 141),
(10380, DATE '2005-02-16', DATE '2005-02-24', DATE '2005-02-18', 'Shipped', NULL, 141),
(10381, DATE '2005-02-17', DATE '2005-02-25', DATE '2005-02-18', 'Shipped', NULL, 321),
(10382, DATE '2005-02-17', DATE '2005-02-23', DATE '2005-02-18', 'Shipped', 'Custom shipping instructions sent to warehouse', 124),
(10383, DATE '2005-02-22', DATE '2005-03-02', DATE '2005-02-25', 'Shipped', NULL, 141),
(10384, DATE '2005-02-23', DATE '2005-03-06', DATE '2005-02-27', 'Shipped', NULL, 321),
(10385, DATE '2005-02-28', DATE '2005-03-09', DATE '2005-03-01', 'Shipped', NULL, 124),
(10386, DATE '2005-03-01', DATE '2005-03-09', DATE '2005-03-06', 'Resolved', 'Disputed then Resolved on 3/15/2005. Customer doesn''t like the craftsmaship of the models.', 141),
(10387, DATE '2005-03-02', DATE '2005-03-09', DATE '2005-03-06', 'Shipped', 'We need to keep in close contact with their Marketing VP. He is the decision maker for all their purchases.', 148); 
INSERT INTO PUBLIC.ORDERS(ORDERNUMBER, ORDERDATE, REQUIREDDATE, SHIPPEDDATE, STATUS, COMMENTS, CUSTOMERNUMBER) VALUES
(10388, DATE '2005-03-03', DATE '2005-03-11', DATE '2005-03-09', 'Shipped', NULL, 462),
(10389, DATE '2005-03-03', DATE '2005-03-09', DATE '2005-03-08', 'Shipped', NULL, 448),
(10390, DATE '2005-03-04', DATE '2005-03-11', DATE '2005-03-07', 'Shipped', 'They want to reevaluate their terms agreement with Finance.', 124),
(10391, DATE '2005-03-09', DATE '2005-03-20', DATE '2005-03-15', 'Shipped', NULL, 276),
(10392, DATE '2005-03-10', DATE '2005-03-18', DATE '2005-03-12', 'Shipped', NULL, 452),
(10393, DATE '2005-03-11', DATE '2005-03-22', DATE '2005-03-14', 'Shipped', 'They want to reevaluate their terms agreement with Finance.', 323),
(10394, DATE '2005-03-15', DATE '2005-03-25', DATE '2005-03-19', 'Shipped', NULL, 141),
(10395, DATE '2005-03-17', DATE '2005-03-24', DATE '2005-03-23', 'Shipped', 'We must be cautions with this customer. Their VP of Sales resigned. Company may be heading down.', 250),
(10396, DATE '2005-03-23', DATE '2005-04-02', DATE '2005-03-28', 'Shipped', NULL, 124),
(10397, DATE '2005-03-28', DATE '2005-04-09', DATE '2005-04-01', 'Shipped', NULL, 242),
(10398, DATE '2005-03-30', DATE '2005-04-09', DATE '2005-03-31', 'Shipped', NULL, 353),
(10399, DATE '2005-04-01', DATE '2005-04-12', DATE '2005-04-03', 'Shipped', NULL, 496),
(10400, DATE '2005-04-01', DATE '2005-04-11', DATE '2005-04-04', 'Shipped', 'Customer requested that DHL is used for this shipping', 450),
(10401, DATE '2005-04-03', DATE '2005-04-14', NULL, 'On Hold', 'Customer credit limit exceeded. Will ship when a payment is received.', 328),
(10402, DATE '2005-04-07', DATE '2005-04-14', DATE '2005-04-12', 'Shipped', NULL, 406),
(10403, DATE '2005-04-08', DATE '2005-04-18', DATE '2005-04-11', 'Shipped', NULL, 201),
(10404, DATE '2005-04-08', DATE '2005-04-14', DATE '2005-04-11', 'Shipped', NULL, 323),
(10405, DATE '2005-04-14', DATE '2005-04-24', DATE '2005-04-20', 'Shipped', NULL, 209),
(10406, DATE '2005-04-15', DATE '2005-04-25', DATE '2005-04-21', 'Disputed', 'Customer claims container with shipment was damaged during shipping and some items were missing. I am talking to FedEx about this.', 145),
(10407, DATE '2005-04-22', DATE '2005-05-04', NULL, 'On Hold', 'Customer credit limit exceeded. Will ship when a payment is received.', 450),
(10408, DATE '2005-04-22', DATE '2005-04-29', DATE '2005-04-27', 'Shipped', NULL, 398),
(10409, DATE '2005-04-23', DATE '2005-05-05', DATE '2005-04-24', 'Shipped', NULL, 166),
(10410, DATE '2005-04-29', DATE '2005-05-10', DATE '2005-04-30', 'Shipped', NULL, 357),
(10411, DATE '2005-05-01', DATE '2005-05-08', DATE '2005-05-06', 'Shipped', NULL, 233),
(10412, DATE '2005-05-03', DATE '2005-05-13', DATE '2005-05-05', 'Shipped', NULL, 141),
(10413, DATE '2005-05-05', DATE '2005-05-14', DATE '2005-05-09', 'Shipped', 'Customer requested that DHL is used for this shipping', 175);       
INSERT INTO PUBLIC.ORDERS(ORDERNUMBER, ORDERDATE, REQUIREDDATE, SHIPPEDDATE, STATUS, COMMENTS, CUSTOMERNUMBER) VALUES
(10414, DATE '2005-05-06', DATE '2005-05-13', NULL, 'On Hold', 'Customer credit limit exceeded. Will ship when a payment is received.', 362),
(10415, DATE '2005-05-09', DATE '2005-05-20', DATE '2005-05-12', 'Disputed', 'Customer claims the scales of the models don''t match what was discussed. I keep all the paperwork though to prove otherwise', 471),
(10416, DATE '2005-05-10', DATE '2005-05-16', DATE '2005-05-14', 'Shipped', NULL, 386),
(10417, DATE '2005-05-13', DATE '2005-05-19', DATE '2005-05-19', 'Disputed', 'Customer doesn''t like the colors and precision of the models.', 141),
(10418, DATE '2005-05-16', DATE '2005-05-24', DATE '2005-05-20', 'Shipped', NULL, 412),
(10419, DATE '2005-05-17', DATE '2005-05-28', DATE '2005-05-19', 'Shipped', NULL, 382),
(10420, DATE '2005-05-29', DATE '2005-06-07', NULL, 'In Process', NULL, 282),
(10421, DATE '2005-05-29', DATE '2005-06-06', NULL, 'In Process', 'Custom shipping instructions were sent to warehouse', 124),
(10422, DATE '2005-05-30', DATE '2005-06-11', NULL, 'In Process', NULL, 157),
(10423, DATE '2005-05-30', DATE '2005-06-05', NULL, 'In Process', NULL, 314),
(10424, DATE '2005-05-31', DATE '2005-06-08', NULL, 'In Process', NULL, 141),
(10425, DATE '2005-05-31', DATE '2005-06-07', NULL, 'In Process', NULL, 119);       
...
-- 273 +/- SELECT COUNT(*) FROM PUBLIC.PAYMENTS;               
INSERT INTO PUBLIC.PAYMENTS(CUSTOMERNUMBER, CHECKNUMBER, PAYMENTDATE, AMOUNT) VALUES
(103, 'HQ336336', DATE '2004-10-19', 6066.78),
(103, 'JM555205', DATE '2003-06-05', 14571.44),
(103, 'OM314933', DATE '2004-12-18', 1676.14),
(112, 'BO864823', DATE '2004-12-17', 14191.12),
(112, 'HQ55022', DATE '2003-06-06', 32641.98),
(112, 'ND748579', DATE '2004-08-20', 33347.88),
(114, 'GG31455', DATE '2003-05-20', 45864.03),
(114, 'MA765515', DATE '2004-12-15', 82261.22),
(114, 'NP603840', DATE '2003-05-31', 7565.08),
(114, 'NR27552', DATE '2004-03-10', 44894.74),
(119, 'DB933704', DATE '2004-11-14', 19501.82),
(119, 'LN373447', DATE '2004-08-08', 47924.19),
(119, 'NG94694', DATE '2005-02-22', 49523.67),
(121, 'DB889831', DATE '2003-02-16', 50218.95),
(121, 'FD317790', DATE '2003-10-28', 1491.38),
(121, 'KI831359', DATE '2004-11-04', 17876.32),
(121, 'MA302151', DATE '2004-11-28', 34638.14),
(124, 'AE215433', DATE '2005-03-05', 101244.59),
(124, 'BG255406', DATE '2004-08-28', 85410.87),
(124, 'CQ287967', DATE '2003-04-11', 11044.3),
(124, 'ET64396', DATE '2005-04-16', 83598.04),
(124, 'HI366474', DATE '2004-12-27', 47142.7),
(124, 'HR86578', DATE '2004-11-02', 55639.66),
(124, 'KI131716', DATE '2003-08-15', 111654.4),
(124, 'LF217299', DATE '2004-03-26', 43369.3),
(124, 'NT141748', DATE '2003-11-25', 45084.38),
(128, 'DI925118', DATE '2003-01-28', 10549.01),
(128, 'FA465482', DATE '2003-10-18', 24101.81),
(128, 'FH668230', DATE '2004-03-24', 33820.62),
(128, 'IP383901', DATE '2004-11-18', 7466.32),
(129, 'DM826140', DATE '2004-12-08', 26248.78),
(129, 'ID449593', DATE '2003-12-11', 23923.93),
(129, 'PI42991', DATE '2003-04-09', 16537.85),
(131, 'CL442705', DATE '2003-03-12', 22292.62),
(131, 'MA724562', DATE '2004-12-02', 50025.35),
(131, 'NB445135', DATE '2004-09-11', 35321.97),
(141, 'AU364101', DATE '2003-07-19', 36251.03),
(141, 'DB583216', DATE '2004-11-01', 36140.38),
(141, 'DL460618', DATE '2005-05-19', 46895.48),
(141, 'HJ32686', DATE '2004-01-30', 59830.55),
(141, 'ID10962', DATE '2004-12-31', 116208.4),
(141, 'IN446258', DATE '2005-03-25', 65071.26),
(141, 'JE105477', DATE '2005-03-18', 120166.58),
(141, 'JN355280', DATE '2003-10-26', 49539.37),
(141, 'JN722010', DATE '2003-02-25', 40206.2),
(141, 'KT52578', DATE '2003-12-09', 63843.55),
(141, 'MC46946', DATE '2004-07-09', 35420.74),
(141, 'MF629602', DATE '2004-08-16', 20009.53),
(141, 'NU627706', DATE '2004-05-17', 26155.91),
(144, 'IR846303', DATE '2004-12-12', 36005.71),
(144, 'LA685678', DATE '2003-04-09', 7674.94),
(145, 'CN328545', DATE '2004-07-03', 4710.73),
(145, 'ED39322', DATE '2004-04-26', 28211.7),
(145, 'HR182688', DATE '2004-12-01', 20564.86),
(145, 'JJ246391', DATE '2003-02-20', 53959.21),
(146, 'FP549817', DATE '2004-03-18', 40978.53),
(146, 'FU793410', DATE '2004-01-16', 49614.72),
(146, 'LJ160635', DATE '2003-12-10', 39712.1),
(148, 'BI507030', DATE '2003-04-22', 44380.15),
(148, 'DD635282', DATE '2004-08-11', 2611.84),
(148, 'KM172879', DATE '2003-12-26', 105743.0),
(148, 'ME497970', DATE '2005-03-27', 3516.04),
(151, 'BF686658', DATE '2003-12-22', 58793.53),
(151, 'GB852215', DATE '2004-07-26', 20314.44);    
INSERT INTO PUBLIC.PAYMENTS(CUSTOMERNUMBER, CHECKNUMBER, PAYMENTDATE, AMOUNT) VALUES
(151, 'IP568906', DATE '2003-06-18', 58841.35),
(151, 'KI884577', DATE '2004-12-14', 39964.63),
(157, 'HI618861', DATE '2004-11-19', 35152.12),
(157, 'NN711988', DATE '2004-09-07', 63357.13),
(161, 'BR352384', DATE '2004-11-14', 2434.25),
(161, 'BR478494', DATE '2003-11-18', 50743.65),
(161, 'KG644125', DATE '2005-02-02', 12692.19),
(161, 'NI908214', DATE '2003-08-05', 38675.13),
(166, 'BQ327613', DATE '2004-09-16', 38785.48),
(166, 'DC979307', DATE '2004-07-07', 44160.92),
(166, 'LA318629', DATE '2004-02-28', 22474.17),
(167, 'ED743615', DATE '2004-09-19', 12538.01),
(167, 'GN228846', DATE '2003-12-03', 85024.46),
(171, 'GB878038', DATE '2004-03-15', 18997.89),
(171, 'IL104425', DATE '2003-11-22', 42783.81),
(172, 'AD832091', DATE '2004-09-09', 1960.8),
(172, 'CE51751', DATE '2004-12-04', 51209.58),
(172, 'EH208589', DATE '2003-04-20', 33383.14),
(173, 'GP545698', DATE '2004-05-13', 11843.45),
(173, 'IG462397', DATE '2004-03-29', 20355.24),
(175, 'IO448913', DATE '2003-11-19', 24879.08),
(175, 'PI15215', DATE '2004-07-10', 42044.77),
(177, 'AU750837', DATE '2004-04-17', 15183.63),
(177, 'CI381435', DATE '2004-01-19', 47177.59),
(181, 'CM564612', DATE '2004-04-25', 22602.36),
(175, 'CITI3434', DATE '2005-05-19', 28500.78),
(209, 'BOAF8204', DATE '2005-05-03', 35157.75),
(181, 'GQ132144', DATE '2003-01-30', 5494.78),
(181, 'OH367219', DATE '2004-11-16', 44400.5),
(186, 'AE192287', DATE '2005-03-10', 23602.9),
(186, 'AK412714', DATE '2003-10-27', 37602.48),
(186, 'KA602407', DATE '2004-10-21', 34341.08),
(187, 'AM968797', DATE '2004-11-03', 52825.29),
(187, 'BQ39062', DATE '2004-12-08', 47159.11),
(187, 'KL124726', DATE '2003-03-27', 48425.69),
(189, 'BO711618', DATE '2004-10-03', 17359.53),
(189, 'NM916675', DATE '2004-03-01', 32538.74),
(198, 'FI192930', DATE '2004-12-06', 9658.74),
(198, 'HQ920205', DATE '2003-07-06', 6036.96),
(198, 'IS946883', DATE '2004-09-21', 5858.56),
(201, 'DP677013', DATE '2003-10-20', 23908.24),
(201, 'OO846801', DATE '2004-06-15', 37258.94),
(202, 'HI358554', DATE '2003-12-18', 36527.61),
(202, 'IQ627690', DATE '2004-11-08', 33594.58),
(204, 'GC697638', DATE '2004-08-13', 51152.86),
(204, 'IS150005', DATE '2004-09-24', 4424.4),
(205, 'GL756480', DATE '2003-12-04', 3879.96),
(205, 'LL562733', DATE '2003-09-05', 50342.74),
(205, 'NM739638', DATE '2005-02-06', 39580.6),
(209, 'ED520529', DATE '2004-06-21', 4632.31),
(209, 'PH785937', DATE '2004-05-04', 36069.26),
(211, 'BJ535230', DATE '2003-12-09', 45480.79),
(216, 'BG407567', DATE '2003-05-09', 3101.4),
(216, 'ML780814', DATE '2004-12-06', 24945.21),
(216, 'MM342086', DATE '2003-12-14', 40473.86),
(219, 'BN17870', DATE '2005-03-02', 3452.75),
(219, 'BR941480', DATE '2003-10-18', 4465.85),
(227, 'MQ413968', DATE '2003-10-31', 36164.46),
(227, 'NU21326', DATE '2004-11-02', 53745.34),
(233, 'II180006', DATE '2004-07-01', 22997.45),
(233, 'JG981190', DATE '2003-11-18', 16909.84),
(239, 'NQ865547', DATE '2004-03-15', 80375.24),
(240, 'IF245157', DATE '2004-11-16', 46788.14),
(240, 'JO719695', DATE '2004-03-28', 24995.61);  
INSERT INTO PUBLIC.PAYMENTS(CUSTOMERNUMBER, CHECKNUMBER, PAYMENTDATE, AMOUNT) VALUES
(242, 'AF40894', DATE '2003-11-22', 33818.34),
(242, 'HR224331', DATE '2005-06-03', 12432.32),
(242, 'KI744716', DATE '2003-07-21', 14232.7),
(249, 'IJ399820', DATE '2004-09-19', 33924.24),
(249, 'NE404084', DATE '2004-09-04', 48298.99),
(250, 'EQ12267', DATE '2005-05-17', 17928.09),
(250, 'HD284647', DATE '2004-12-30', 26311.63),
(250, 'HN114306', DATE '2003-07-18', 23419.47),
(256, 'EP227123', DATE '2004-02-10', 5759.42),
(256, 'HE84936', DATE '2004-10-22', 53116.99),
(259, 'EU280955', DATE '2004-11-06', 61234.67),
(259, 'GB361972', DATE '2003-12-07', 27988.47),
(260, 'IO164641', DATE '2004-08-30', 37527.58),
(260, 'NH776924', DATE '2004-04-24', 29284.42),
(276, 'EM979878', DATE '2005-02-09', 27083.78),
(276, 'KM841847', DATE '2003-11-13', 38547.19),
(276, 'LE432182', DATE '2003-09-28', 41554.73),
(276, 'OJ819725', DATE '2005-04-30', 29848.52),
(278, 'BJ483870', DATE '2004-12-05', 37654.09),
(278, 'GP636783', DATE '2003-03-02', 52151.81),
(278, 'NI983021', DATE '2003-11-24', 37723.79),
(282, 'IA793562', DATE '2003-08-03', 24013.52),
(282, 'JT819493', DATE '2004-08-02', 35806.73),
(282, 'OD327378', DATE '2005-01-03', 31835.36),
(286, 'DR578578', DATE '2004-10-28', 47411.33),
(286, 'KH910279', DATE '2004-09-05', 43134.04),
(298, 'AJ574927', DATE '2004-03-13', 47375.92),
(298, 'LF501133', DATE '2004-09-18', 61402.0),
(299, 'AD304085', DATE '2003-10-24', 36798.88),
(299, 'NR157385', DATE '2004-09-05', 32260.16),
(311, 'DG336041', DATE '2005-02-15', 46770.52),
(311, 'FA728475', DATE '2003-10-06', 32723.04),
(311, 'NQ966143', DATE '2004-04-25', 16212.59),
(314, 'LQ244073', DATE '2004-08-09', 45352.47),
(314, 'MD809704', DATE '2004-03-03', 16901.38),
(319, 'HL685576', DATE '2004-11-06', 42339.76),
(319, 'OM548174', DATE '2003-12-07', 36092.4),
(320, 'GJ597719', DATE '2005-01-18', 8307.28),
(320, 'HO576374', DATE '2003-08-20', 41016.75),
(320, 'MU817160', DATE '2003-11-24', 52548.49),
(321, 'DJ15149', DATE '2003-11-03', 85559.12),
(321, 'LA556321', DATE '2005-03-15', 46781.66),
(323, 'AL493079', DATE '2005-05-23', 75020.13),
(323, 'ES347491', DATE '2004-06-24', 37281.36),
(323, 'HG738664', DATE '2003-07-05', 2880.0),
(323, 'PQ803830', DATE '2004-12-24', 39440.59),
(324, 'DQ409197', DATE '2004-12-13', 13671.82),
(324, 'FP443161', DATE '2003-07-07', 29429.14),
(324, 'HB150714', DATE '2003-11-23', 37455.77),
(328, 'EN930356', DATE '2004-04-16', 7178.66),
(328, 'NR631421', DATE '2004-05-30', 31102.85),
(333, 'HL209210', DATE '2003-11-15', 23936.53),
(333, 'JK479662', DATE '2003-10-17', 9821.32),
(333, 'NF959653', DATE '2005-03-01', 21432.31),
(334, 'CS435306', DATE '2005-01-27', 45785.34),
(334, 'HH517378', DATE '2003-08-16', 29716.86),
(334, 'LF737277', DATE '2004-05-22', 28394.54),
(339, 'AP286625', DATE '2004-10-24', 23333.06),
(339, 'DA98827', DATE '2003-11-28', 34606.28),
(344, 'AF246722', DATE '2003-11-24', 31428.21),
(344, 'NJ906924', DATE '2004-04-02', 15322.93),
(347, 'DG700707', DATE '2004-01-18', 21053.69),
(347, 'LG808674', DATE '2003-10-24', 20452.5);          
INSERT INTO PUBLIC.PAYMENTS(CUSTOMERNUMBER, CHECKNUMBER, PAYMENTDATE, AMOUNT) VALUES
(350, 'BQ602907', DATE '2004-12-11', 18888.31),
(350, 'CI471510', DATE '2003-05-25', 50824.66),
(350, 'OB648482', DATE '2005-01-29', 1834.56),
(353, 'CO351193', DATE '2005-01-10', 49705.52),
(353, 'ED878227', DATE '2003-07-21', 13920.26),
(353, 'GT878649', DATE '2003-05-21', 16700.47),
(353, 'HJ618252', DATE '2005-06-09', 46656.94),
(357, 'AG240323', DATE '2003-12-16', 20220.04),
(357, 'NB291497', DATE '2004-05-15', 36442.34),
(362, 'FP170292', DATE '2004-07-11', 18473.71),
(362, 'OG208861', DATE '2004-09-21', 15059.76),
(363, 'HL575273', DATE '2004-11-17', 50799.69),
(363, 'IS232033', DATE '2003-01-16', 10223.83),
(363, 'PN238558', DATE '2003-12-05', 55425.77),
(379, 'CA762595', DATE '2005-02-12', 28322.83),
(379, 'FR499138', DATE '2003-09-16', 32680.31),
(379, 'GB890854', DATE '2004-08-02', 12530.51),
(381, 'BC726082', DATE '2004-12-03', 12081.52),
(381, 'CC475233', DATE '2003-04-19', 1627.56),
(381, 'GB117430', DATE '2005-02-03', 14379.9),
(381, 'MS154481', DATE '2003-08-22', 1128.2),
(382, 'CC871084', DATE '2003-05-12', 35826.33),
(382, 'CT821147', DATE '2004-08-01', 6419.84),
(382, 'PH29054', DATE '2004-11-27', 42813.83),
(385, 'BN347084', DATE '2003-12-02', 20644.24),
(385, 'CP804873', DATE '2004-11-19', 15822.84),
(385, 'EK785462', DATE '2003-03-09', 51001.22),
(386, 'DO106109', DATE '2003-11-18', 38524.29),
(386, 'HG438769', DATE '2004-07-18', 51619.02),
(398, 'AJ478695', DATE '2005-02-14', 33967.73),
(398, 'DO787644', DATE '2004-06-21', 22037.91),
(398, 'KB54275', DATE '2004-11-29', 48927.64),
(406, 'HJ217687', DATE '2004-01-28', 49165.16),
(406, 'NA197101', DATE '2004-06-17', 25080.96),
(412, 'GH197075', DATE '2004-07-25', 35034.57),
(412, 'PJ434867', DATE '2004-04-14', 31670.37),
(415, 'ER54537', DATE '2004-09-28', 31310.09),
(424, 'KF480160', DATE '2004-12-07', 25505.98),
(424, 'LM271923', DATE '2003-04-16', 21665.98),
(424, 'OA595449', DATE '2003-10-31', 22042.37),
(447, 'AO757239', DATE '2003-09-15', 6631.36),
(447, 'ER615123', DATE '2003-06-25', 17032.29),
(447, 'OU516561', DATE '2004-12-17', 26304.13),
(448, 'FS299615', DATE '2005-04-18', 27966.54),
(448, 'KR822727', DATE '2004-09-30', 48809.9),
(450, 'EF485824', DATE '2004-06-21', 59551.38),
(452, 'ED473873', DATE '2003-11-15', 27121.9),
(452, 'FN640986', DATE '2003-11-20', 15130.97),
(452, 'HG635467', DATE '2005-05-03', 8807.12),
(455, 'HA777606', DATE '2003-12-05', 38139.18),
(455, 'IR662429', DATE '2004-05-12', 32239.47),
(456, 'GJ715659', DATE '2004-11-13', 27550.51),
(456, 'MO743231', DATE '2004-04-30', 1679.92),
(458, 'DD995006', DATE '2004-11-15', 33145.56),
(458, 'NA377824', DATE '2004-02-06', 22162.61),
(458, 'OO606861', DATE '2003-06-13', 57131.92),
(462, 'ED203908', DATE '2005-04-15', 30293.77),
(462, 'GC60330', DATE '2003-11-08', 9977.85),
(462, 'PE176846', DATE '2004-11-27', 48355.87),
(471, 'AB661578', DATE '2004-07-28', 9415.13),
(471, 'CO645196', DATE '2003-12-10', 35505.63),
(473, 'LL427009', DATE '2004-02-17', 7612.06),
(473, 'PC688499', DATE '2003-10-27', 17746.26);             
INSERT INTO PUBLIC.PAYMENTS(CUSTOMERNUMBER, CHECKNUMBER, PAYMENTDATE, AMOUNT) VALUES
(475, 'JP113227', DATE '2003-12-09', 7678.25),
(475, 'PB951268', DATE '2004-02-13', 36070.47),
(484, 'GK294076', DATE '2004-10-26', 3474.66),
(484, 'JH546765', DATE '2003-11-29', 47513.19),
(486, 'BL66528', DATE '2004-04-14', 5899.38),
(486, 'HS86661', DATE '2004-11-23', 45994.07),
(486, 'JB117768', DATE '2003-03-20', 25833.14),
(487, 'AH612904', DATE '2003-09-28', 29997.09),
(487, 'PT550181', DATE '2004-02-29', 12573.28),
(489, 'OC773849', DATE '2003-12-04', 22275.73),
(489, 'PO860906', DATE '2004-01-31', 7310.42),
(495, 'BH167026', DATE '2003-12-26', 59265.14),
(495, 'FN155234', DATE '2004-05-14', 6276.6),
(496, 'EU531600', DATE '2005-05-25', 30253.75),
(496, 'MB342426', DATE '2003-07-16', 32077.44),
(496, 'MN89921', DATE '2004-12-31', 52166.0),
(233, 'BOFA2323', DATE '2005-05-20', 29070.38),
(398, 'JPMR4544', DATE '2005-05-18', 615.45),
(406, 'BJMPR455', DATE '2005-04-23', 12190.85);       
...
CREATE CACHED TABLE PUBLIC.PRODUCTLINES(
    PRODUCTLINE VARCHAR(50) NOT NULL,
    TEXTDESCRIPTION VARCHAR(4000),
    HTMLDESCRIPTION VARCHAR(500),
    IMAGE BINARY
);        
ALTER TABLE PUBLIC.PRODUCTLINES ADD CONSTRAINT PUBLIC.CONSTRAINT_C7 PRIMARY KEY(PRODUCTLINE);  
-- 7 +/- SELECT COUNT(*) FROM PUBLIC.PRODUCTLINES;             
